...
import com.runpod.runpod.SecretArgs;
...
public class Secret extends com.pulumi.resources.CustomResource {
    ...
    public Secret(java.lang.String name, SecretArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("runpod:index:Secret", name, makeArgs(args, options), makeResourceOptions(options, Codegen.empty()), false);
    }
    ...
    private Secret(java.lang.String name, Output<java.lang.String> id, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("runpod:index:Secret", name, null, makeResourceOptions(options, id), false);
    }
