...
package com.pulumi.runpod;

import com.pulumi.core.Output;
import com.pulumi.core.annotations.Export;
import com.pulumi.core.annotations.ResourceType;
import com.pulumi.core.internal.Codegen;
import com.pulumi.runpod.RandomArgs;
import com.pulumi.runpod.Utilities;
import java.lang.Integer;
import java.lang.String;
import javax.annotation.Nullable;

@ResourceType(type="runpod:index:Random")
public class Random extends com.pulumi.resources.CustomResource {
    ...
    public Random(java.lang.String name, RandomArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("runpod:index:Random", name, makeArgs(args, options), makeResourceOptions(options, Codegen.empty()), false);
    }
    ...
    private Random(java.lang.String name, Output<java.lang.String> id, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("runpod:index:Random", name, null, makeResourceOptions(options, id), false);
    }
