...
class NetworkVolumeArgs:
    def __init__(__self__, *,
                 ...
                 is_next_gen_storage: Optional[pulumi.Input[_builtins.bool]] = None):
        """
        The set of arguments for constructing a NetworkVolume resource.

        :param pulumi.Input[_builtins.str] data_center_id: The data center ID where the volume will be created (e.g. "US-TX-3").
        :param pulumi.Input[_builtins.str] name: A name for the network volume.
        :param pulumi.Input[_builtins.int] size: The size of the network volume in GB.
        :param pulumi.Input[_builtins.bool] is_next_gen_storage: Whether to use next-generation storage.
        """
    ...
    def is_next_gen_storage(self) -> Optional[pulumi.Input[_builtins.bool]]:
        """
    ...
    def is_next_gen_storage(self, value: Optional[pulumi.Input[_builtins.bool]]):
...
class NetworkVolume(pulumi.CustomResource):
    ...
    @_builtins.property
    @pulumi.getter(name="isNextGenStorage")
    def is_next_gen_storage(self) -> pulumi.Output[Optional[_builtins.bool]]:
        """
        Whether to use next-generation storage.
        """
        return pulumi.get(self, "is_next_gen_storage")
    ...
    def network_volume_id(self) -> pulumi.Output[_builtins.str]:
        """
    ...
    def storage_cluster_id(self) -> pulumi.Output[Optional[_builtins.str]]:
        """
