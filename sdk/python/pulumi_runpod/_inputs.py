...
class SavingsPlanArgsDict(TypedDict):
    plan_length: NotRequired[pulumi.Input[Optional[_builtins.str]]]
    """
    The length of the savings plan.
    """
    upfront_cost: NotRequired[pulumi.Input[Optional[_builtins.float]]]
    """
...
class SavingsPlanArgs:
    def __init__(__self__, *,
                 plan_length: pulumi.Input[Optional[_builtins.str]] = None,
                 upfront_cost: pulumi.Input[Optional[_builtins.float]] = None):
        """
        :param pulumi.Input[_builtins.str] plan_length: The length of the savings plan.
        :param pulumi.Input[_builtins.float] upfront_cost: The upfront cost for the savings plan.
        """
    ...
    def plan_length(self) -> pulumi.Input[Optional[_builtins.str]]:
        """
        The length of the savings plan.
        """
    ...
    @plan_length.setter
    def plan_length(self, value: pulumi.Input[Optional[_builtins.str]]):
        pulumi.set(self, "plan_length", value)

    @_builtins.property
    @pulumi.getter(name="upfrontCost")
    def upfront_cost(self) -> pulumi.Input[Optional[_builtins.float]]:
        """
        The upfront cost for the savings plan.
        """
    ...
    @upfront_cost.setter
    def upfront_cost(self, value: pulumi.Input[Optional[_builtins.float]]):
